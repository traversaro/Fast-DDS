...
from discovery.fast_daemon.daemon.daemonize import daemonize

from discovery.fast_daemon.helpers import get_ros_domain_id
from discovery.fast_daemon.helpers import wait_for
...
def spawn_daemon(timeout=None, debug=False):
    """
